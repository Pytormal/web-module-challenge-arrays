...
const myArra2 = copy(originalFlavors)
...
// originalFlavors.push("9")
console.log(originalFlavors.length, myArra2.length)
...
// const myArra2 = copy(originalFlavors)
console.log(myArra2, myArra2.length)
...
function filterByWord(arr, I) {
    ...
    //             newArr = arr.includes(e => e !== newArr.push(search_term));
    //         }
    //     }
    //     console.log(newArr)
    //     return newArr
...
let newArray = filterByWord(originalFlavors, "Chocolate")
